    ...
    <DivAboutMe>
      ...
      <MainDiv>
        ...
        <MainDivLine>
          ...
          <span className="red">"08/2016 - 12/2016": "Tradição Mineira Indústria - Estágio em Engenharia de Produção"</span>
          <span className="yellow">&#125;</span>,
        </MainDivLine>
        <MainDivLine>
          <span className="numbers">10</span>
          <span className="yellowIndentedThrice">&#123;</span>
          <span className="red">"08/2019 - 06/2020": "Pabú Izakaya - Auxiliar Administrativo"</span>
          <span className="yellow">&#125;</span>,
        </MainDivLine>
        <MainDivLine>
          <span className="numbers">11</span>
          <span className="yellowIndentedThrice">&#123;</span>
          <span className="red">"08/2019 - 06/2020": "Colégio Marista - Auxiliar Administrativo"</span>
          <span className="yellow">&#125;</span>,
        </MainDivLine>
        <MainDivLine>
          <span className="numbers">12</span>
          <span className="yellowIndentedThrice">&#123;</span>
          <span className="red">"08/2019 - 06/2020": "Eataly Paris - Recepcionista"</span>
          <span className="yellow">&#125;</span>
        </MainDivLine>
        <MainDivLine>
        ...
        <MainDivLine>
          ...
          <span className="yellowIndentedThrice">&#123;</span>
          <span className="red">"02/2011 - 12/2016": "Universidade do Estado de Minas Gerais - Engenharia de Produção"</span>
          <span className="yellow">&#125;</span>,
        </MainDivLine>
        <MainDivLine>
          <span className="numbers">17</span>
          <span className="yellowIndentedThrice">&#123;</span>
          <span className="red">"05/2021 - now": "Kenzie Academy Brasil - Desenvolvedora Web FullStack"</span>
          <span className="yellow">&#125;</span>
        </MainDivLine>
        <MainDivLine>
        ...
        <MainDivLine>
          ...
          <span className="yellowIndentedThrice">&#123;</span>
          <span className="red">"08/2013 - 12/2015": "Graduação Sanduíche/Eng. de Produção - University of Wisconsin - Estados Unidos"</span>
          <span className="yellow">&#125;</span>,
        </MainDivLine>
        <MainDivLine>
          <span className="numbers">22</span>
          <span className="yellowIndentedThrice">&#123;</span>
          <span className="red">"03/2019 - 03/2020": "Working Holiday - Paris/França"</span>
          <span className="yellow">&#125;</span>
        </MainDivLine>
        <MainDivLine>
          <span className="numbers">26</span>
        ...
        <MainDivLine>
          ...
          <span className="purpleIndentedTwice">return </span>
          <span className='yellow'>[</span>
          <span className="red">'HTML','CSS','Javascript','ReactJS','Redux','Python','GIT','npm/yarn','Flask','Docker'</span>
          <span className='yellow'>]</span>
        </MainDivLine>
        <MainDivLine>
          <span className="numbers">26</span>
        ...
        <MainDivLine>
          ...
          <span className="yellow">&#125; </span>
          <BlinkingCursor> <span>|</span></BlinkingCursor>
        </MainDivLine>
      </MainDiv>
    </DivAboutMe>
